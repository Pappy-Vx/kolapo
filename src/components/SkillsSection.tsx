        ...
        <header className="flex flex-col items-center justify-center">
          <div className="overflow-hidden flex items-center justify-center mb-5 rounded-full bg-secondary h-16 w-16 p-4">
            <svg
              ...
              stroke="#0D0628"
            >
              <g id="SVGRepoBgCarrier" stroke-width="0" />
          ...
          <p className="text-lg font-normal">
            I enjoy designing scalable architectures, optimizing data flow, and
            crafting the logic that powers seamless digital experiences.
          </p>
        </header>
        <div className="py-12">
          <h2 className="text-lg font-medium text-primary">
